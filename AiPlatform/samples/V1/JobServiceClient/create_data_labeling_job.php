...
function create_data_labeling_job_sample(
    ...
    string $formattedDatasetsElement,
    ...
    $formattedDatasets = [$formattedDatasetsElement,];
...
function callSample(): void
{
    ...
    $formattedDatasetsElement = JobServiceClient::datasetName('[PROJECT]', '[LOCATION]', '[DATASET]');
