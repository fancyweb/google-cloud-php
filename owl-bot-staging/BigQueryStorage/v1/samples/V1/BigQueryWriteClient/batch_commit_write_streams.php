 ...
 * for read operations.
 *
 * @param string $formattedParent     Parent table that all the streams should belong to, in the form of
 *                                    `projects/{project}/datasets/{dataset}/tables/{table}`. Please see
